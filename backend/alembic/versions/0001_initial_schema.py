...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("action_deck", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("boss_deck", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("addon_deck", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("action_discard", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("boss_discard", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("addon_discard", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("turn_order", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
